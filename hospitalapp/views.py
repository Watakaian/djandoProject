...
def token(request):
    consumer_key = 'TTFeB1Ac3jAQ9uRGZG4hjdnfXUnrGCbQjaB42D6RwzccP1hT'
    consumer_secret = 'RBa3pGCdHOP7MvWcpEqsC3GEMzbVi7i6bAFS3xBBPMQnNLEQc42CGdViKL8roOIw'
...
def stk(request):
    if request.method =="POST":
        ...
        return HttpResponse("<h1>The transaction was a success</h1>")
